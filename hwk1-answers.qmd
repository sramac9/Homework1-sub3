...
load("Homework1-Sub3_workspace.Rdata")
```
...
My experience working with this data was frustrating at first because I did not know how to use to software that the assignment required. However, once I spent more hours playing around in Github and VS code, I found completing questions and successfully rendering documents to be extremely rewarding. I feel confident that I will be able to work with filepaths and clean data sets in the next homework assignment more effectively than I was able to in this assignment.
